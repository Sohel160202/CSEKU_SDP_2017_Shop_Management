...
$sql_query3="SELECT * from product where shop_id like '$id'";
$result3=mysqli_query($con,$sql_query3);
while($row3=mysqli_fetch_assoc($result3))
{
	array_push($response, array("product"=>$row3['product_name'],"quantity"=>$row3['quantity'],"price"=>$row3['price'],"sell"=>$row3['sell']));
}
