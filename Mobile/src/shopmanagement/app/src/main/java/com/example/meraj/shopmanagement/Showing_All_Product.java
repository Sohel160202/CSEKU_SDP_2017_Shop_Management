...
public class Showing_All_Product extends AppCompatActivity {
    ...
    String name,quantity,price,sell;
    @Override
    ...
    public class ProductAdapter extends ArrayAdapter{
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if(productView==null)
            {
                ...
                productHolder.sell=(TextView)productView.findViewById(R.id.sell);
            ...
            productHolder.sell.setText("Sell: "+product.getPsell());
        ...
        class productHolder{
            TextView name,quantity,price,sell;
        }
    }
            ...
            String Email=params[0];
                try {
                    ...
                    while(count<jsonArray.length())
                    {
                        ...
                        Product product=new Product(name,quantity,price,sell);
    ...
    public class Product{
        String pname,pquantity,pprice,psell;

        public Product(String pname, String pquantity, String pprice, String psell) {
            this.pname = pname;
